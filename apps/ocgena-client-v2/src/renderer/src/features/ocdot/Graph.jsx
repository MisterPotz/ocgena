...
class Graph extends React.Component {
  ...
  handleError(errorMessage) {
    ...
    this.rendering = false;
    console.log("setting new state in handle error");
  ...
  renderGraph() {
    ...
    if (this.props.dotSrc === this.prevDotSrc 
      && true
      /* && this.props.engine === this.prevEngine && this.props.fit === this.prevFit */) {
      return;
    }
    if (this.rendering) {
    ...
    console.log("setting new state in render graph");
  ...
  handleRenderGraphReady() {
    ...
    console.log("setting new state in handle renderer");
    this.setState({busy: false});
    if (this.pendingUpdate) {
      this.pendingUpdate = false;
      this.renderGraph();
...
//<path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.789 3 7.938l3-2.647z"></path>
