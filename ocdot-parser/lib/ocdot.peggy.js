...
function peg$parse(input, options) {
    ...
    const peg$c48 = 'places';
    const peg$c49 = peg$literalExpectation('places', false);
    const peg$c50 = 'transitions';
    const peg$c51 = peg$literalExpectation('transitions', false);
    const peg$c52 = function (special_type, id, _body) {
        const body = _body ?? [];
        return id
    ...
    const peg$c55 = 'ne';
    const peg$c56 = peg$literalExpectation('ne', false);
    const peg$c57 = 'e';
    const peg$c58 = peg$literalExpectation('e', false);
    const peg$c59 = 'se';
    const peg$c60 = peg$literalExpectation('se', false);
    const peg$c61 = 's';
    const peg$c62 = peg$literalExpectation('s', false);
    const peg$c63 = 'sw';
    const peg$c64 = peg$literalExpectation('sw', false);
    const peg$c65 = 'w';
    const peg$c66 = peg$literalExpectation('w', false);
    const peg$c67 = 'nw';
    const peg$c68 = peg$literalExpectation('nw', false);
    ...
    const peg$c88 = peg$otherExpectation('UNICODE_STRING');
    ...
    const peg$c93 = '_';
    const peg$c94 = peg$literalExpectation('_', false);
    ...
    const peg$c102 = function (n) {
        return text();
    };
    const peg$c103 = function (v) {
        return {
            type: 'literal',
    ...
    const peg$c117 = peg$otherExpectation('end of line');
    const peg$c118 = '\n';
    const peg$c119 = peg$literalExpectation('\n', false);
    const peg$c120 = '\r\n';
    const peg$c121 = peg$literalExpectation('\r\n', false);
    const peg$c122 = '\r';
    const peg$c123 = peg$literalExpectation('\r', false);
    const peg$c124 = '\u2028';
    const peg$c125 = peg$literalExpectation('\u2028', false);
    const peg$c126 = '\u2029';
    const peg$c127 = peg$literalExpectation('\u2029', false);
    const peg$c128 = function (chars) {
        return chars.join('');
    };
    const peg$c129 = /^[^"\\\0-\x1F\x7F]/;
    const peg$c130 = peg$classExpectation(['"', '\\', ['\0', '\x1F'], '\x7F'], true, false);
    const peg$c131 = '\\"';
