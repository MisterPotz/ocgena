...
function peg$parse(input, options) {
    ...
    const peg$c35 = function (id, v) {
        return v;
    };
    const peg$c36 = function (id, rest) {
        return {
            type: 'node_ref_group',
            body: [id, ...rest],
            location: location(),
    ...
    const peg$c53 = 'object types';
    const peg$c54 = peg$literalExpectation('object types', false);
    const peg$c55 = function (special_type, id, _body) {
        const body = _body ?? [];
        return id
            ? { type: 'subgraph', id, specialType: special_type, body, location: location() }
            : { type: 'subgraph', specialType: special_type, body, location: location() };
    };
    const peg$c56 = 'n';
    const peg$c57 = peg$literalExpectation('n', false);
    const peg$c58 = 'ne';
    const peg$c59 = peg$literalExpectation('ne', false);
    const peg$c60 = 'e';
    const peg$c61 = peg$literalExpectation('e', false);
    const peg$c62 = 'se';
    const peg$c63 = peg$literalExpectation('se', false);
    const peg$c64 = 's';
    const peg$c65 = peg$literalExpectation('s', false);
    const peg$c66 = 'sw';
    const peg$c67 = peg$literalExpectation('sw', false);
    const peg$c68 = 'w';
    const peg$c69 = peg$literalExpectation('w', false);
    const peg$c70 = 'nw';
    const peg$c71 = peg$literalExpectation('nw', false);
    ...
    const peg$c87 = function (v) {
        return v.join('');
    };
    const peg$c88 = function (lines) {
        return {
            type: 'comment',
            kind: 'macro',
            value: dedent(lines.join('\n')),
    ...
    const peg$c91 = peg$otherExpectation('UNICODE_STRING');
    ...
    const peg$c96 = '_';
    const peg$c97 = peg$literalExpectation('_', false);
    const peg$c98 = peg$otherExpectation('NUMBER');
    const peg$c99 = '-';
    ...
    const peg$c105 = function (n) {
        return text();
    };
    const peg$c106 = function (v) {
        return {
            type: 'literal',
    ...
    const peg$c120 = peg$otherExpectation('end of line');
    const peg$c121 = '\n';
    const peg$c122 = peg$literalExpectation('\n', false);
    const peg$c123 = '\r\n';
    const peg$c124 = peg$literalExpectation('\r\n', false);
    const peg$c125 = '\r';
    const peg$c126 = peg$literalExpectation('\r', false);
    const peg$c127 = '\u2028';
    const peg$c128 = peg$literalExpectation('\u2028', false);
    const peg$c129 = '\u2029';
    const peg$c130 = peg$literalExpectation('\u2029', false);
    const peg$c131 = function (chars) {
        return chars.join('');
    };
    const peg$c132 = /^[^"\\\0-\x1F\x7F]/;
    const peg$c133 = peg$classExpectation(['"', '\\', ['\0', '\x1F'], '\x7F'], true, false);
    const peg$c134 = '\\"';
    ...
    const peg$c146 = /^[\u02B0-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0374\u037A\u0559\u0640\u06E5-\u06E6\u07F4-\u07F5\u07FA\u081A\u0824\u0828\u0971\u0E46\u0EC6\u10FC\u17D7\u1843\u1AA7\u1C78-\u1C7D\u1D2C-\u1D6A\u1D78\u1D9B-\u1DBF\u2071\u207F\u2090-\u209C\u2C7C-\u2C7D\u2D6F\u2E2F\u3005\u3031-\u3035\u303B\u309D-\u309E\u30FC-\u30FE\uA015\uA4F8-\uA4FD\uA60C\uA67F\uA717-\uA71F\uA770\uA788\uA7F8-\uA7F9\uA9CF\uAA70\uAADD\uAAF3-\uAAF4\uFF70\uFF9E-\uFF9F]/;
    ...
    const peg$c150 = /^[\u01C5\u01C8\u01CB\u01F2\u1F88-\u1F8F\u1F98-\u1F9F\u1FA8-\u1FAF\u1FBC\u1FCC\u1FFC]/;
    ...
    const peg$c154 = /^[\u16EE-\u16F0\u2160-\u2182\u2185-\u2188\u3007\u3021-\u3029\u3038-\u303A\uA6E6-\uA6EF]/;
    ...
    const peg$c156 = /^[0-9\u0660-\u0669\u06F0-\u06F9\u07C0-\u07C9\u0966-\u096F\u09E6-\u09EF\u0A66-\u0A6F\u0AE6-\u0AEF\u0B66-\u0B6F\u0BE6-\u0BEF\u0C66-\u0C6F\u0CE6-\u0CEF\u0D66-\u0D6F\u0E50-\u0E59\u0ED0-\u0ED9\u0F20-\u0F29\u1040-\u1049\u1090-\u1099\u17E0-\u17E9\u1810-\u1819\u1946-\u194F\u19D0-\u19D9\u1A80-\u1A89\u1A90-\u1A99\u1B50-\u1B59\u1BB0-\u1BB9\u1C40-\u1C49\u1C50-\u1C59\uA620-\uA629\uA8D0-\uA8D9\uA900-\uA909\uA9D0-\uA9D9\uAA50-\uAA59\uABF0-\uABF9\uFF10-\uFF19]/;
