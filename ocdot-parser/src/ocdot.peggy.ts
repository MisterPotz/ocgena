...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c35 = function (id: any, v: any): any {
    return v;
  };
  const peg$c36 = function (id: any, rest: any): any {
    return {
      type: 'node_ref_group',
      body: [id, ...rest],
      location: location(),
  ...
  const peg$c41 = function (operator: any): any {
    return { type: operator, location: location() };
  };
  const peg$c42 = function (edgeop: any, id: any, rest: any): any {
    edgeops.push(edgeop);
    return [{ id, edgeop }].concat(rest || []);
  };
  const peg$c43 = function (id: any, port: any): any {
  ...
  const peg$c48 = function (port: any, compass: any): any {
  ...
  const peg$c88 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'macro',
      value: dedent(lines.join('\n')),
  ...
  const peg$c105 = function (n: any): any {
    return text();
  };
  ...
  const peg$c116 = function (v: any): any {
    return v[1] === '"' ? '"' : v[0] + v[1];
  };
  ...
  const peg$c131 = function (chars: any): any {
    return chars.join('');
  };
