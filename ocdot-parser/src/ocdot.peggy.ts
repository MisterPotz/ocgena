...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c31 = function (id: any, v: any): any {
    return v;
  };
  ...
  const peg$c43 = function (port: any, compass: any): any {
    return compass;
  };
  const peg$c44 = function (port: any, compass: any): any {
  ...
  const peg$c52 = function (special_type: any, id: any, _body: any): any {
    const body = _body ?? [];
    return id
  ...
  const peg$c69 = function (value: any): any {
  ...
  const peg$c80 = function (v: any): any {
    return {
      type: 'comment',
      kind: 'block',
  ...
  const peg$c81 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'slash',
  ...
  const peg$c102 = function (n: any): any {
    return text();
  };
  ...
  const peg$c109 = function (chars: any): any {
    return {
      type: 'literal',
      value: chars.join(''),
      quoted: true,
  ...
  const peg$c128 = function (chars: any): any {
    return chars.join('');
  };
