...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c112 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'slash',
  ...
  const peg$c115 = function (v: any): any {
    return v.join('');
  };
  const peg$c116 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'macro',
      value: dedent(lines.join('\n')),
  ...
  const peg$c129 = function (n: any): any {
    return text();
  };
  const peg$c130 = function (v: any): any {
    return {
      type: 'literal',
  ...
  const peg$c135 = function (v: any): any {
    return '<' + v.join('') + '>';
  };
  const peg$c136 = function (chars: any): any {
    return {
      type: 'literal',
      value: chars.join(''),
      quoted: true,
  ...
  const peg$c140 = function (v: any): any {
    return v[1] === '"' ? '"' : v[0] + v[1];
  };
  ...
  const peg$c155 = function (chars: any): any {
    return chars.join('');
  };
  ...
  const peg$c160 = function (): any {
    return '"';
  };
  const peg$c161 = function (): any {
    return '\\';
  };
