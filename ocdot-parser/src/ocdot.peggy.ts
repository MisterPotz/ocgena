...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c11 = function (keyValue: any): any {
    return {
      type: 'attribute',
      ...keyValue,
      location: location(),
  ...
  const peg$c18 = function (_kind: any, body: any): any {
    const kind = _kind.toLowerCase();
    return { type: 'attributes', kind, body, location: location() };
  };
  const peg$c19 = function (id: any, rhs: any, _body: any): any {
    return {
      type: 'edge',
      body: _body ?? [],
      from: id,
  ...
  const peg$c20 = function (id: any, _body: any): any {
    return {
      type: 'node',
      id,
      body: _body ?? [],
  ...
  const peg$c23 = function (key: any, value: any): any {
    return { key, value };
  };
  const peg$c24 = ',';
  ...
  const peg$c40 = function (op_params: any, operator: any): any {
    return op_params
  ...
  const peg$c53 = function (subgraph_keyword: any, id: any, _body: any): any {
    const body = _body ?? [];
  ...
  const peg$c80 = function (expression: any): any {
    return {
      type: 'expression',
      ...expression,
      location: location(),
  ...
  const peg$c94 = function (sign: any, value: any): any {
    if (!sign && sign == '+') {
      return value;
    }
  ...
  const peg$c95 = peg$otherExpectation('integer');
  const peg$c96 = /^[0-9]/;
  const peg$c97 = peg$classExpectation([['0', '9']], false, false);
  const peg$c98 = function (): any {
    return { head: parseInt(text(), 10), tail: [] };
  };
  const peg$c99 = peg$otherExpectation('variable');
  ...
  const peg$c110 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'slash',
  ...
  const peg$c113 = function (v: any): any {
    return v.join('');
  };
  const peg$c114 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'macro',
      value: dedent(lines.join('\n')),
  ...
  const peg$c117 = peg$otherExpectation('UNICODE_STRING');
  ...
  const peg$c122 = '_';
  const peg$c123 = peg$literalExpectation('_', false);
  const peg$c124 = peg$otherExpectation('NUMBER');
  const peg$c125 = '.';
  const peg$c126 = peg$literalExpectation('.', false);
  const peg$c127 = function (n: any): any {
    return text();
  };
  const peg$c128 = function (v: any): any {
    return {
      type: 'literal',
  ...
  const peg$c134 = function (chars: any): any {
    return {
      type: 'literal',
      value: chars.join(''),
      quoted: true,
  ...
  const peg$c138 = function (v: any): any {
    return v[1] === '"' ? '"' : v[0] + v[1];
  };
  ...
  const peg$c142 = peg$otherExpectation('end of line');
  const peg$c143 = '\n';
  const peg$c144 = peg$literalExpectation('\n', false);
  const peg$c145 = '\r\n';
  const peg$c146 = peg$literalExpectation('\r\n', false);
  const peg$c147 = '\r';
  const peg$c148 = peg$literalExpectation('\r', false);
  const peg$c149 = '\u2028';
  const peg$c150 = peg$literalExpectation('\u2028', false);
  const peg$c151 = '\u2029';
  const peg$c152 = peg$literalExpectation('\u2029', false);
  const peg$c153 = function (chars: any): any {
    return chars.join('');
  };
  const peg$c154 = /^[^"\\\0-\x1F\x7F]/;
  const peg$c155 = peg$classExpectation(['"', '\\', ['\0', '\x1F'], '\x7F'], true, false);
  const peg$c156 = '\\"';
  ...
  const peg$c161 = peg$otherExpectation('WHITESPACE');
  const peg$c162 = /^[\n\r]/;
  const peg$c163 = peg$classExpectation(['\n', '\r'], false, false);
  const peg$c164 = /^[ \t]/;
  const peg$c165 = peg$classExpectation([' ', '\t'], false, false);
  const peg$c166 =
  ...
  const peg$c172 = /^[\u01C5\u01C8\u01CB\u01F2\u1F88-\u1F8F\u1F98-\u1F9F\u1FA8-\u1FAF\u1FBC\u1FCC\u1FFC]/;
  ...
  const peg$c176 = /^[\u16EE-\u16F0\u2160-\u2182\u2185-\u2188\u3007\u3021-\u3029\u3038-\u303A\uA6E6-\uA6EF]/;
  ...
  function peg$parse_edge_subgraph_id(): any {
    let s0, s1, s2, s3, s4;
  ...
  function peg$parse_edge_subgraph(): any {
  ...
  function peg$parse_op_params(): any {
    let s0, s1;
  ...
  function peg$parseRootExpression(): any {
    let s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseExpressionOp(): any {
    let s0, s1, s2, s3, s4;
