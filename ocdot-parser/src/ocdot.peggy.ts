...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c40 = function (op_params: any, operator: any): any {
    return { type: operator, params: op_params, location: location() };
  };
  ...
  const peg$c55 = function (special_type: any, id: any, _body: any): any {
    const body = _body ?? [];
    return id
  ...
  const peg$c76 = function (v: any): any {
    return {
      type: 'literal',
      ...v,
      location: location(),
  ...
  const peg$c85 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'slash',
  ...
  const peg$c89 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'macro',
      value: dedent(lines.join('\n')),
  ...
  const peg$c92 = peg$otherExpectation('UNICODE_STRING');
  const peg$c93 = function (first: any, rest: any): any {
    return first + rest.join('');
  };
  const peg$c94 = function (first: any, rest: any): any {
    return first + rest;
  };
  const peg$c95 = '$';
  const peg$c96 = peg$literalExpectation('$', false);
  const peg$c97 = '_';
  const peg$c98 = peg$literalExpectation('_', false);
  ...
  const peg$c106 = function (n: any): any {
    return text();
  };
  ...
  const peg$c117 = function (v: any): any {
    return v[1] === '"' ? '"' : v[0] + v[1];
  };
  ...
  const peg$c121 = peg$otherExpectation('end of line');
  const peg$c122 = '\n';
  const peg$c123 = peg$literalExpectation('\n', false);
  const peg$c124 = '\r\n';
  const peg$c125 = peg$literalExpectation('\r\n', false);
  const peg$c126 = '\r';
  const peg$c127 = peg$literalExpectation('\r', false);
  const peg$c128 = '\u2028';
  ...
  const peg$c133 = /^[^"\\\0-\x1F\x7F]/;
  const peg$c134 = peg$classExpectation(['"', '\\', ['\0', '\x1F'], '\x7F'], true, false);
  const peg$c135 = '\\"';
  ...
  const peg$c143 = /^[ \t]/;
  const peg$c144 = peg$classExpectation([' ', '\t'], false, false);
  const peg$c145 =
  ...
  const peg$c151 = /^[\u01C5\u01C8\u01CB\u01F2\u1F88-\u1F8F\u1F98-\u1F9F\u1FA8-\u1FAF\u1FBC\u1FCC\u1FFC]/;
  ...
  const peg$c155 = /^[\u16EE-\u16F0\u2160-\u2182\u2185-\u2188\u3007\u3021-\u3029\u3038-\u303A\uA6E6-\uA6EF]/;
