...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c35 = function (number: any): any {
    return {
      number,
    };
  };
  ...
  const peg$c63 = function (subgraph_keyword: any, id: any, _body: any): any {
    const body = _body ?? [];
  ...
  const peg$c80 = function (value: any): any {
  ...
  const peg$c84 = function (v: any): any {
    return {
      type: 'literal',
      ...v,
      location: location(),
  ...
  const peg$c86 = function (value: any): any {
    return {
      type: 'literal',
      value,
      quoted: false,
  ...
  const peg$c92 = function (v: any): any {
    return {
      type: 'comment',
      kind: 'block',
  ...
  const peg$c93 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'slash',
  ...
  const peg$c96 = function (v: any): any {
    return v.join('');
  };
  const peg$c97 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'macro',
      value: dedent(lines.join('\n')),
  ...
  const peg$c114 = function (n: any): any {
    return text();
  };
  ...
  const peg$c120 = function (v: any): any {
    return '<' + v.join('') + '>';
  };
  ...
  const peg$c140 = function (chars: any): any {
    return chars.join('');
  };
