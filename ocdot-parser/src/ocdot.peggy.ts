...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c109 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'slash',
  ...
  const peg$c113 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'macro',
      value: dedent(lines.join('\n')),
  ...
  const peg$c126 = function (n: any): any {
    return text();
  };
  ...
  const peg$c133 = function (chars: any): any {
    return {
      type: 'literal',
      value: chars.join(''),
      quoted: true,
  ...
  const peg$c134 = function (): any {
    return text();
  };
  const peg$c135 = '\\';
  const peg$c136 = peg$literalExpectation('\\', false);
  const peg$c137 = function (v: any): any {
    return v[1] === '"' ? '"' : v[0] + v[1];
  };
  const peg$c138 = function (): any {
    return '';
  };
  const peg$c139 = /^[\n\r\u2028\u2029]/;
  ...
  const peg$c152 = function (chars: any): any {
    return chars.join('');
  };
