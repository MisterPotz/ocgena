...
import { ShapeDelegateNew } from "./shapeDelegates"
import { ELEMENT_CHILD_PREFIX, MARK_SELECTION_PREFIX, TRANSFORMER_PREFIX } from "./Keywords"
import { getRealHeight, getRealWidth, height, width } from "./primitiveShapeUtils"
...
function createEscapeListener(onEscapeCallback: () => void) {
    ...
    return function selfRemovableOnEscape(this: Document, ev: KeyboardEvent): any {
