...
class ByObjTypeAndArcGroupingStrategy @Inject constructor(): TransitionGroupedTokenInfo.TokenGroupingStrategy {
    override fun findTokenBatchForOTypeAndArc(
        ...
        return sourceTokenBatches.find { tokenBatch: TokenBatch ->
            tokenBatch.objectTypeId == objectTypeId && arcMeta == tokenBatch.arcMeta
        }
    }
}