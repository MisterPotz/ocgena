package ru.misterpotz.ocgena.dsl.test_config
...
class ConfigLoadTest {
    ...
    fun simConfigUpdatesOk() {
        ...
        Assertions.assertEquals(
            15..15,
            updatedSimConfig.transitionInstancesTimesSpec["t1"].duration.intRange
        )
        Assertions.assertEquals(
            0..0,
            updatedSimConfig.transitionInstancesTimesSpec["t1"].timeUntilNextInstanceIsAllowed.intRange
        )
        Assertions.assertEquals(
            10,
