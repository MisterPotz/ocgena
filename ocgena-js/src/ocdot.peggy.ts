...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$c48 = function (id: any, _body: any): any {
    const body = _body ?? [];
  ...
  const peg$c65 = function (value: any): any {
  ...
  const peg$c69 = function (v: any): any {
    return {
      type: 'literal',
      ...v,
      location: location(),
  ...
  const peg$c77 = function (lines: any): any {
    return {
      type: 'comment',
      kind: 'slash',
  ...
  const peg$c98 = function (n: any): any {
    return text();
  };
  ...
  const peg$c105 = function (chars: any): any {
    return {
      type: 'literal',
      value: chars.join(''),
      quoted: true,
  ...
  const peg$c124 = function (chars: any): any {
    return chars.join('');
  };
