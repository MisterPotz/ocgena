...
function peg$parse(input, options) {
    ...
    const peg$c14 = 'node';
    const peg$c15 = peg$literalExpectation('node', true);
    const peg$c16 = 'edge';
    const peg$c17 = peg$literalExpectation('edge', true);
    const peg$c18 = function (_kind, body) {
    ...
    const peg$c20 = function (id, _body) {
        return {
            type: 'node',
            id,
            body: _body ?? [],
    ...
    const peg$c23 = function (key, value) {
        return { key, value };
    };
    const peg$c24 = ',';
    ...
    const peg$c30 = function (list) {
        return list;
    };
    const peg$c31 = 'subgraph';
    const peg$c32 = peg$literalExpectation('subgraph', true);
    const peg$c33 = function (id) {
        return id;
    };
    const peg$c34 = function (id, _body) {
        const body = _body ?? [];
        return id
            ? { type: 'edge_subgraph', id, body, location: location() }
            : { type: 'edge_subgraph', body, location: location() };
    };
    const peg$c35 = function (expression) {
        return {
            ...expression,
        };
    };
    ...
    const peg$c40 = function (op_params, operator) {
        return op_params
            ? { type: operator, params: op_params, location: location() }
            : { type: operator, location: location() };
    };
    ...
    const peg$c48 = function (id) {
        return id;
    };
    const peg$c49 = 'places';
    const peg$c50 = peg$literalExpectation('places', false);
    const peg$c51 = 'transitions';
    const peg$c52 = peg$literalExpectation('transitions', false);
    const peg$c53 = function (subgraph_keyword, id, _body) {
        const body = _body ?? [];
        let specialType = null;
        const specialTypes = ['places', 'transitions'];
        if (specialTypes.indexOf(subgraph_keyword) >= 0) {
            specialType = subgraph_keyword;
        }
        return id
            ? { type: 'subgraph', id, specialType, body, location: location() }
            : { type: 'subgraph', specialType, body, location: location() };
    };
    const peg$c54 = 'n';
    const peg$c55 = peg$literalExpectation('n', false);
    const peg$c56 = 'ne';
    const peg$c57 = peg$literalExpectation('ne', false);
    const peg$c58 = 'e';
    const peg$c59 = peg$literalExpectation('e', false);
    const peg$c60 = 'se';
    const peg$c61 = peg$literalExpectation('se', false);
    const peg$c62 = 's';
    const peg$c63 = peg$literalExpectation('s', false);
    const peg$c64 = 'sw';
    const peg$c65 = peg$literalExpectation('sw', false);
    const peg$c66 = 'w';
    const peg$c67 = peg$literalExpectation('w', false);
    const peg$c68 = 'nw';
    const peg$c69 = peg$literalExpectation('nw', false);
    ...
    const peg$c80 = function (expression) {
        return {
            type: 'expression',
            ...expression,
            location: location(),
    ...
    const peg$c81 = function (head, tail) {
        return {
            infix: [...head.infix, ...(tail ? tail.flatMap((a) => a.infix) : [])],
        };
    };
    const peg$c82 = '+';
    ...
    const peg$c86 = function (op, target) {
        return {
    ...
    const peg$c91 = function (op, target) {
        return {
            infix: [op, ...target.infix],
        };
    };
    const peg$c92 = function (head, tail) {
        return {
            infix: [...head.infix, ...(tail ? tail.flatMap((a) => a.infix) : [])],
        };
    };
    const peg$c93 = function (expr) {
        return {
            infix: ['(', ...expr.infix, ')'],
        };
    };
    const peg$c94 = function (integer) {
        return {
            infix: [integer],
        };
    };
    const peg$c95 = function (variable) {
        return {
            infix: [variable],
        };
    };
    const peg$c96 = function (sign, value) {
        if (sign) {
            return {
    ...
    const peg$c101 = peg$otherExpectation('variable');
    ...
    const peg$c110 = peg$anyExpectation();
    const peg$c111 = function (v) {
        return {
            type: 'comment',
            kind: 'block',
    ...
    const peg$c115 = function (v) {
        return v.join('');
    };
    const peg$c116 = function (lines) {
        return {
            type: 'comment',
            kind: 'macro',
            value: dedent(lines.join('\n')),
    ...
    const peg$c119 = peg$otherExpectation('UNICODE_STRING');
    const peg$c120 = function (first, rest) {
        return first + rest.join('');
    };
    const peg$c121 = function (first, rest) {
        return first + rest;
    };
    const peg$c122 = '$';
    const peg$c123 = peg$literalExpectation('$', false);
    const peg$c124 = '_';
    const peg$c125 = peg$literalExpectation('_', false);
    const peg$c126 = peg$otherExpectation('NUMBER');
    const peg$c127 = '.';
    const peg$c128 = peg$literalExpectation('.', false);
    const peg$c129 = function (n) {
        return text();
    };
    const peg$c130 = function (v) {
        return {
            type: 'literal',
    ...
    const peg$c135 = function (v) {
        return '<' + v.join('') + '>';
    };
    const peg$c136 = function (chars) {
        return {
            type: 'literal',
            value: chars.join(''),
            quoted: true,
    ...
    const peg$c137 = function () {
        return text();
    };
    const peg$c138 = '\\';
    const peg$c139 = peg$literalExpectation('\\', false);
    const peg$c140 = function (v) {
        return v[1] === '"' ? '"' : v[0] + v[1];
    };
    ...
    const peg$c144 = peg$otherExpectation('end of line');
    const peg$c145 = '\n';
    const peg$c146 = peg$literalExpectation('\n', false);
    const peg$c147 = '\r\n';
    const peg$c148 = peg$literalExpectation('\r\n', false);
    const peg$c149 = '\r';
    const peg$c150 = peg$literalExpectation('\r', false);
    const peg$c151 = '\u2028';
    const peg$c152 = peg$literalExpectation('\u2028', false);
    const peg$c153 = '\u2029';
    const peg$c154 = peg$literalExpectation('\u2029', false);
    const peg$c155 = function (chars) {
        return chars.join('');
    };
    const peg$c156 = /^[^"\\\0-\x1F\x7F]/;
    const peg$c157 = peg$classExpectation(['"', '\\', ['\0', '\x1F'], '\x7F'], true, false);
    const peg$c158 = '\\"';
    ...
    const peg$c170 = /^[\u02B0-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0374\u037A\u0559\u0640\u06E5-\u06E6\u07F4-\u07F5\u07FA\u081A\u0824\u0828\u0971\u0E46\u0EC6\u10FC\u17D7\u1843\u1AA7\u1C78-\u1C7D\u1D2C-\u1D6A\u1D78\u1D9B-\u1DBF\u2071\u207F\u2090-\u209C\u2C7C-\u2C7D\u2D6F\u2E2F\u3005\u3031-\u3035\u303B\u309D-\u309E\u30FC-\u30FE\uA015\uA4F8-\uA4FD\uA60C\uA67F\uA717-\uA71F\uA770\uA788\uA7F8-\uA7F9\uA9CF\uAA70\uAADD\uAAF3-\uAAF4\uFF70\uFF9E-\uFF9F]/;
    ...
    const peg$c174 = /^[\u01C5\u01C8\u01CB\u01F2\u1F88-\u1F8F\u1F98-\u1F9F\u1FA8-\u1FAF\u1FBC\u1FCC\u1FFC]/;
    const peg$c175 = peg$classExpectation([
        '\u01C5',
        '\u01C8',
        '\u01CB',
        '\u01F2',
    ...
    const peg$c176 = /^[A-Z\xC0-\xD6\xD8-\xDE\u0100\u0102\u0104\u0106\u0108\u010A\u010C\u010E\u0110\u0112\u0114\u0116\u0118\u011A\u011C\u011E\u0120\u0122\u0124\u0126\u0128\u012A\u012C\u012E\u0130\u0132\u0134\u0136\u0139\u013B\u013D\u013F\u0141\u0143\u0145\u0147\u014A\u014C\u014E\u0150\u0152\u0154\u0156\u0158\u015A\u015C\u015E\u0160\u0162\u0164\u0166\u0168\u016A\u016C\u016E\u0170\u0172\u0174\u0176\u0178-\u0179\u017B\u017D\u0181-\u0182\u0184\u0186-\u0187\u0189-\u018B\u018E-\u0191\u0193-\u0194\u0196-\u0198\u019C-\u019D\u019F-\u01A0\u01A2\u01A4\u01A6-\u01A7\u01A9\u01AC\u01AE-\u01AF\u01B1-\u01B3\u01B5\u01B7-\u01B8\u01BC\u01C4\u01C7\u01CA\u01CD\u01CF\u01D1\u01D3\u01D5\u01D7\u01D9\u01DB\u01DE\u01E0\u01E2\u01E4\u01E6\u01E8\u01EA\u01EC\u01EE\u01F1\u01F4\u01F6-\u01F8\u01FA\u01FC\u01FE\u0200\u0202\u0204\u0206\u0208\u020A\u020C\u020E\u0210\u0212\u0214\u0216\u0218\u021A\u021C\u021E\u0220\u0222\u0224\u0226\u0228\u022A\u022C\u022E\u0230\u0232\u023A-\u023B\u023D-\u023E\u0241\u0243-\u0246\u0248\u024A\u024C\u024E\u0370\u0372\u0376\u0386\u0388-\u038A\u038C\u038E-\u038F\u0391-\u03A1\u03A3-\u03AB\u03CF\u03D2-\u03D4\u03D8\u03DA\u03DC\u03DE\u03E0\u03E2\u03E4\u03E6\u03E8\u03EA\u03EC\u03EE\u03F4\u03F7\u03F9-\u03FA\u03FD-\u042F\u0460\u0462\u0464\u0466\u0468\u046A\u046C\u046E\u0470\u0472\u0474\u0476\u0478\u047A\u047C\u047E\u0480\u048A\u048C\u048E\u0490\u0492\u0494\u0496\u0498\u049A\u049C\u049E\u04A0\u04A2\u04A4\u04A6\u04A8\u04AA\u04AC\u04AE\u04B0\u04B2\u04B4\u04B6\u04B8\u04BA\u04BC\u04BE\u04C0-\u04C1\u04C3\u04C5\u04C7\u04C9\u04CB\u04CD\u04D0\u04D2\u04D4\u04D6\u04D8\u04DA\u04DC\u04DE\u04E0\u04E2\u04E4\u04E6\u04E8\u04EA\u04EC\u04EE\u04F0\u04F2\u04F4\u04F6\u04F8\u04FA\u04FC\u04FE\u0500\u0502\u0504\u0506\u0508\u050A\u050C\u050E\u0510\u0512\u0514\u0516\u0518\u051A\u051C\u051E\u0520\u0522\u0524\u0526\u0531-\u0556\u10A0-\u10C5\u10C7\u10CD\u1E00\u1E02\u
A72E\uA732\uA734\uA736\uA738\uA73A\uA73C\uA73E\uA740\uA742\uA744\uA746\uA748\uA74A\uA74C\uA74E\uA750\uA752\uA754\uA756\uA758\uA75A\uA75C\uA75E\uA760\uA762\uA764\uA766\uA768\uA76A\uA76C\uA76E\uA779\uA77B\uA77D-\uA77E\uA780\uA782\uA784\uA786\uA78B\uA78D\uA790\uA792\uA7A0\uA7A2\uA7A4\uA7A6\uA7A8\uA7AA\uFF21-\uFF3A]/;
    ...
    const peg$c178 = /^[\u16EE-\u16F0\u2160-\u2182\u2185-\u2188\u3007\u3021-\u3029\u3038-\u303A\uA6E6-\uA6EF]/;
    ...
    const peg$c180 = /^[0-9\u0660-\u0669\u06F0-\u06F9\u07C0-\u07C9\u0966-\u096F\u09E6-\u09EF\u0A66-\u0A6F\u0AE6-\u0AEF\u0B66-\u0B6F\u0BE6-\u0BEF\u0C66-\u0C6F\u0CE6-\u0CEF\u0D66-\u0D6F\u0E50-\u0E59\u0ED0-\u0ED9\u0F20-\u0F29\u1040-\u1049\u1090-\u1099\u17E0-\u17E9\u1810-\u1819\u1946-\u194F\u19D0-\u19D9\u1A80-\u1A89\u1A90-\u1A99\u1B50-\u1B59\u1BB0-\u1BB9\u1C40-\u1C49\u1C50-\u1C59\uA620-\uA629\uA8D0-\uA8D9\uA900-\uA909\uA9D0-\uA9D9\uAA50-\uAA59\uABF0-\uABF9\uFF10-\uFF19]/;
    ...
    function peg$parseattibutes_item() {
        let s0, s1, s2, s3;
        s0 = peg$currPos;
        s1 = peg$parse__();
        if (s1 !== peg$FAILED) {
    ...
    function peg$parsecluster_statements() {
        let s0, s1;
        s0 = [];
        s1 = peg$parseedge();
        if (s1 === peg$FAILED) {
            ...
            if (s2 !== peg$FAILED) {
                ...
                if (s3 !== peg$FAILED) {
                    ...
                    if (s4 !== peg$FAILED) {
                        ...
                        if (s5 !== peg$FAILED) {
                            s6 = peg$parsecluster_statements();
                            if (s6 !== peg$FAILED) {
                                s7 = peg$parse__();
                                if (s7 !== peg$FAILED) {
    ...
    function peg$parse_edge_subgraph_id() {
        let s0, s1, s2, s3, s4;
        s0 = peg$currPos;
    ...
    function peg$parse_edge_subgraph() {
        let s0, s1, s2, s3, s4, s5, s6, s7;
        s0 = peg$currPos;
        s1 = peg$parse_();
        if (s1 !== peg$FAILED) {
            s2 = peg$parse_edge_subgraph_id();
            if (s2 !== peg$FAILED) {
                s3 = peg$parse_();
                if (s3 !== peg$FAILED) {
                    if (input.charCodeAt(peg$currPos) === 123) {
                    ...
                    if (s4 !== peg$FAILED) {
                        s5 = peg$parsecluster_statements();
                        if (s5 === peg$FAILED) {
                            s5 = null;
                        }
                        if (s5 !== peg$FAILED) {
    ...
    function peg$parse_edge_target() {
        let s0;
        s0 = peg$parse_edge_subgraph();
        if (s0 === peg$FAILED) {
            s0 = peg$parsenode_ref();
        }
        return s0;
    }
    function peg$parse_op_params() {
        let s0, s1;
        s0 = peg$currPos;
        s1 = peg$parseRootExpression();
        if (s1 === peg$FAILED) {
            s1 = peg$parse_number();
        }
        if (s1 !== peg$FAILED) {
    ...
    function peg$parseRootExpression() {
        let s0, s1, s2, s3, s4, s5;
        s0 = peg$currPos;
    ...
    function peg$parseExpressionOp() {
        let s0, s1, s2, s3, s4;
        s0 = peg$currPos;
        s1 = peg$parse_();
        if (s1 !== peg$FAILED) {
